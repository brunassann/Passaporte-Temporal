document.addEventListener("DOMContentLoaded", () => {
    ...
    const songs = [
      "./music/playlist/＂Hino da Independência＂ - Anthem of The Empire of Brazil.mp3",
      "./music/playlist/Paródia da Música Nego Drama (Pedro Drama) [ejDsTKEnVdY].mp3",
      "./music/playlist/O Poder Moderador.mp3",
      "./music/playlist/A Batalha da Cisplatina.mp3",
      "./music/playlist/Modinha Imperial.mp3",
    ];

  
    // Inicializa o Swiper – verifique se os arquivos da biblioteca foram importados no HTML
    ...
    // Atualiza a música quando o slide muda
